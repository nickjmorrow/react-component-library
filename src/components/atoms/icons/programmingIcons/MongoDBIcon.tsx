...
export const MongoDBIcon: React.SFC<IconProps> = ({ sizeVariant, colorVariant = 'core', ...svgProps }) => (
    <DefaultIconSvg
        {...svgProps}
    ...
    >
        <g id="Layer_3" />
        <g id="Layer_1">
            <path fill="#D7D8D9" d="M35.2,3.3C35.2,3.3,35.1,3.2,35.2,3.3C35.1,3.2,35.2,3.3,35.2,3.3L35.2,3.3z" />
            <g id="Layer_2_1_" />
