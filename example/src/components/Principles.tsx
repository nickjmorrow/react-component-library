...
export const Principles: React.FC = () => {
  return (
    <ContentWrapper>
	  ...
	  <Typography>For organizing components, I tried to follow <Link route={'https://bradfrost.com/blog/post/atomic-web-design/'}>Atomic Design</Link>. It helped drive me to focus on breaking down designs into atoms, designing the atoms, ensuring all of the atoms followed the design system and looked like they were related, and then ensuring the composition of the larger component was easy and pain-free.</Typography>
    </ContentWrapper>
  );
};
