...
export const AppBarDemo: React.FC = () => {
    ...
    const rightComponents = (
        <>
            <Button useMargin={false} styleVariant={3} textColorVariant={'secondaryDark'}>
                Sign In
            </Button>
            <Button useMargin={false} styleVariant={3} textColorVariant={'secondaryDark'}>
                Log In
    ...
    return (
        <Wrapper spacing={spacing}>
            ...
            <SectionWrapper spacing={spacing}>
                <Typography styleVariant={'h2'}>Populated AppBar with No Props</Typography>
            ...
            <SectionWrapper spacing={spacing}>
                ...
                <div style={{ display: 'grid', gridRowGap: '48px' }}>
                    <PopulatedAppBar appName={'Primary Populated'} navInfos={sampleMenuOptions} />
                    <PopulatedAppBar
                        styleVariant={2}
                        ...
                        menuLength={'short'}
                    />
                    <PopulatedAppBar styleVariant={3} appName={'Tertiary Populated'} navInfos={sampleMenuOptions} />
                </div>
            </SectionWrapper>
            <SectionWrapper spacing={spacing}>
                <Typography styleVariant={'h2'}>Primary</Typography>
                <AppBar styleVariant={1}>
                    <AppNameTypography colorVariant={'primaryLight'}>My AppBar</AppNameTypography>
                </AppBar>
            </SectionWrapper>
            <SectionWrapper spacing={spacing}>
