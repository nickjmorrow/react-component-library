...
import { IOption, Select, ThemeContext, Typography, Multiselect } from '@nickjmorrow/react-component-library';
    ...
    return (
        <div style={{ marginBottom: spacing.ss48 }}>
            ...
            <DisplayPaper style={paperStyles}>
                <div>
                    <Select options={options} currentOption={currentOption} onChange={setOption} />
                </div>
                <div>
                    <Select
