...
export const ButtonsDemo: React.SFC = () => {
    ...
    return (
        <Wrapper>
            ...
            <DisplayPaper>
                <Button styleVariant={2} textColorVariant="core" colorVariant="core" useMargin={true}>
                    Core
                </Button>
                <Button styleVariant={2} textColorVariant="accent" colorVariant="accent" useMargin={true}>
                    Accent
                </Button>
                <Button textColorVariant="success" styleVariant={2} colorVariant="success" useMargin={true}>
                    Success
                </Button>
                <Button textColorVariant="warning" styleVariant={2} colorVariant="warning" useMargin={true}>
                    Warning
                </Button>
                <Button textColorVariant="danger" styleVariant={2} colorVariant="danger" useMargin={true}>
                    Danger
                </Button>
            </DisplayPaper>
            ...
            <DisplayPaper>
                ...
                <Button styleVariant={3} textColorVariant="accent" colorVariant="accent">
                    Accent
                </Button>
                <Button textColorVariant="success" styleVariant={3} colorVariant="success">
                    Success
                </Button>
                <Button textColorVariant="warning" styleVariant={3} colorVariant="warning">
                    Warning
                </Button>
                <Button textColorVariant="danger" styleVariant={3} colorVariant="danger">
                    Danger
                </Button>
            </DisplayPaper>
            ...
            <DisplayPaper>
                <Button isLoading={isLoading} onClick={toggleIsLoading} textColorVariant={'primaryLight'}>
                    He's loading!
                </Button>
                <Button isLoading={isLoading} onClick={toggleIsLoading} styleVariant={2} textColorVariant={'core'}>
                    I'm loading
                </Button>
            </DisplayPaper>
