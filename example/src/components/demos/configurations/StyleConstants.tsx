    ...
    return (
        <>
            ...
            <DescriptionContainer>
                <Typography>
                    There are miscellaneous flags and settings that are centralized within the component system and
                    consumed by certain components. For instance, all components that have a box-shadow will check the
                    `defaultShouldShowBoxShadow` flag. These settings can be changed by consuming applications.
                </Typography>
            </DescriptionContainer>
            ...
            <div style={{ display: 'grid', gridAutoFlow: 'row', gridRowGap: '8px' }}>
                <Toggle isToggled={defaultShowBoxShadow} onClick={handleToggleBoxShadow} />
                <Button
                    onClick={() => {
                        return;
                    }}
