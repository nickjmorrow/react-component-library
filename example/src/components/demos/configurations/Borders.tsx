...
import { Slider, ThemeContext, ThemeInputsContext, Typography } from '@nickjmorrow/react-component-library';
    ...
    return (
        <>
            ...
            <Slider
                ...
                onChange={(value: number) => updateThemeInputs({ border: { borderRadius: { br1: value } } })}
            />
        </>
    );
};
